 <?php
    ...
    $canbokhoa__Get_All = $canbokhoa->canbokhoa__Get_All();
 ...
 <div class="content-wrapper">
     ...
     <section class="content-header">
         <div class="container-fluid">
             <div class="row mb-2">
                 <div class="col-sm-6">
                     <h1>Quản lý cán bộ khoa</h1>
                 </div>
                 <div class="col-sm-6">
                     <ol class="breadcrumb float-sm-right">
                         <li class="breadcrumb-item"><a href="#">Home</a></li>
                         <li class="breadcrumb-item active">Quản lý cán bộ khoa</li>
                     </ol>
                 </div>
             </div>
         </div><!-- /.container-fluid -->
         ...
         <div class="card card-primary">
             <div class="card-header">
                 ...
                 <div class="card-tools">
                     <form action="quan-ly-can-bo-khoa/action.php?req=import" method="post"
     ...
     <section class="content">
         <form class="row form" action="quan-ly-can-bo-khoa/action.php?req=add" method="post"
                         ...
                         <div class="row">
                             <div class="col-6">
                                 <div class="form-group">
                                     <label for="">Mã cán bộ khoa <span class="color-crimson">(*)</span></label>
                                     <input type="text" id="ma_can_bo_khoa" name="ma_can_bo_khoa" class="form-control"
                                         required placeholder="Nhập mã cán bộ khoa">
                                 </div>
                                 <div class="form-group">
                                     <label for="">Tên cán bộ khoa <span class="color-crimson">(*)</span></label>
                                     <input type="text" id="ten_can_bo_khoa" name="ten_can_bo_khoa" class="form-control"
                                         required placeholder="Nhập tên cán bộ khoa">
                                 </div>
                             </div>
                             <div class="col-6">
                                 <div class="form-group">
             ...
             <div class="card-body">
                 <table id="tablejs" class="table table-bordered table-striped display responsive nowrap" width="100%">
                     <thead>
                         <tr>
                             <th>#</th>
                             <th>Mã cán bộ khoa</th>
                             <th>Tên cán bộ khoa</th>
                             <th>Giới tính</th>
                             <th>Ngày sinh</th>
                             <th>Email</th>
                     ...
                     <tbody>
                         <?php $num = 0;?>
                         <?php foreach($canbokhoa__Get_All as $item):?>
                         <tr>
                             <td><?=++$num?></td>
                             <td><?=$item->ma_can_bo_khoa?></td>
                             <td><?=$item->ten_can_bo_khoa?></td>
                             ...
                             <td>
                                 <a href="#" type="button" class="btn  btn-warning m-2"
                                     onclick="update_obj(<?=$item->id_can_bo_khoa?>)">
                                     <i class="fas fa-edit"></i>
                                 </a>
                                 <a href="#" type="button" class="btn  btn-danger m-2"
                                     onclick="return confirm_sweet('quan-ly-can-bo-khoa/action.php?req=delete&id_can_bo_khoa=<?=$item->id_can_bo_khoa?>')">
 ...
 <script>
function update_obj(id_can_bo_khoa) {
    $.post('quan-ly-can-bo-khoa/update.php', {
        'id_can_bo_khoa': id_can_bo_khoa,
    }, function(data) {
