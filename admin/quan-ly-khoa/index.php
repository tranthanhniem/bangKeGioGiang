                 ...
                 <table id="tablejs" class="table table-bordered table-striped display responsive nowrap" width="100%">
                     ...
                     <tbody>
                         ...
                         <tr>
                             ...
                             <td><?=$item->ghi_chu?></td>
                             <td>
                                 <a href="#" type="button" class="btn  btn-warning m-2" onclick="update_obj(<?=$item->id_khoa?>)">
                                     <i class="fas fa-edit"></i>
                                 </a>
                                 <a href="#" type="button" class="btn  btn-danger m-2"
                                     onclick="return confirm_sweet('quan-ly-khoa/action.php?req=delete&id_khoa=<?=$item->id_khoa?>')">
